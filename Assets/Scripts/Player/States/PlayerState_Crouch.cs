...
{
    public PlayerState_Crouch(PlayerStateMachine stateMachine) : base(stateMachine) { }
    ...
    public override void Tick(float deltaTime)
    {
        ...
        if (!playerController.Inputs.CrouchHeld) stateMachine.SwitchState(playerController.LocomotionState);
